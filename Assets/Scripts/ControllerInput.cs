...
public class ControllerInput : MonoBehaviour {
    ...
    void Update() {
        ...
        GameObject playerShip = Controller.playerShip;
        Transform shipTransform = playerShip.transform;
        ...
        if(Input.GetAxis("RightStickHorizontal") != 0) {
            ...
            if(Controller.selectedPOI == null || advancedMode) {
                ...
                shipTransform.RotateAround(Controller.instance.raycastCam.transform.parent.position, Vector3.up, Time.deltaTime * Input.GetAxis("RightStickHorizontal") * xRotationSpeed);
            }
        ...
        if(Input.GetAxis("RightStickVertical") != 0) {
            if(Controller.selectedPOI == null || advancedMode) {
                ...
                Debug.LogWarningFormat("New Rotation: {0}", afterShipRotation.x);
