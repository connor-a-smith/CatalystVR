...
public class PhotoController : MonoBehaviour
{
    ...
    public bool movingPhotos = false;
    ...
    public void UnloadPhotos()
    {
        ...
        GameObject.Destroy(photoHolder);
        photoHolder = null;
        photos.Clear();
    ...
    public IEnumerator LoadImagesExtern(List<Sprite> spriteList, string photoPath)
    {
    ...
    public IEnumerator LoadImagesIntern(List<Sprite> spriteList, string photoPath)
    {
